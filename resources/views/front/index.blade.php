...
@section('title', 'Sewa Perlengkapan Climbing')
@section('content')
	...
	<main class="max-w-[640px] mx-auto min-h-screen flex flex-col relative has-[#Bottom-nav]:pb-[144px]">
		<div id="Top-navbar" class="flex items-center justify-between pt-5 px-5">
			<a href="{{ route('front.index') }}" class="flex shrink-0">
				<img src="{{ asset('assets/images/logos/logo-2.png') }}" alt="logo" style="width: 40%"/>
			</a>
		...
		<section id="Categories" class="flex flex-col gap-[10px] mt-[30px] px-5">
			<h2 class="font-semibold text-lg leading-[27px]">Categories</h2>
		...
		<a id="promo" href="#" class="px-5 mt-[30px]">
			<div class="w-full aspect-[353/100] flex shrink-0 overflow-hidden rounded-2xl">
				<img src="{{ asset('assets/images/backgrounds/banner-promo.png') }}" class="w-full h-full object-cover" alt="promo" />
			</div>
		</a>
		<section id="New" class="flex flex-col gap-[10px] mt-[30px]">
			<h2 class="font-semibold text-lg leading-[27px] px-5">Latest Items</h2>
					...
					<div class="flex items-center gap-3">
						...
						<div class="w-full flex flex-col gap-1">
							<p class="font-semibold">
								{{ $item_random_product->name }}
							</p>
							<div class="flex items-center justify-between">
								<p class="text-sm leading-[21px] text-[#6E6E70]">
									Rp {{ number_format($item_random_product->price, 0, ',','.') }}/day
								</p>
					...
					<a href="{{ route('front.index') }}">
						<div class="group flex flex-col items-center text-center gap-2 transition-all duration-300 hover:text-black">
							<div class="w-6 h-6 flex shrink-0">
								...
								<img src="{{ asset('assets/images/icons/ecosystem_10426968.png') }}" alt="">
							</div>
